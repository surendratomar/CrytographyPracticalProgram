public class ColumnTransposition9
{
    ...
    public ColumnTransposition9(String myKey)
    {
        selectedKey = myKey;
        sortedKeyPos = new int[selectedKey.length()];
        sortedKey = selectedKey.toCharArray();
    ...
    {
        ColumnTransposition9 tc = new ColumnTransposition9();
        System.out.println("Encrypted Message is: "
                + tc.doEncryption("SurendraTomar"));
        System.out.println("Decrypted Message is: "
                + tc.doDecryption(tc.doEncryption("SurendraTomar")));
    }
}
